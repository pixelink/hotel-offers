#
# Table structure for table 'tx_hoteloffers_domain_model_offer'
#
CREATE TABLE tx_hoteloffers_domain_model_offer (
	...
	booking_range_start int(11) DEFAULT '0' NOT NULL,
	booking_range_end date DEFAULT '0000-00-00',
...
#
# Table structure for table 'tx_hoteloffers_domain_model_offerrange'
#
CREATE TABLE tx_hoteloffers_domain_model_offerrange (
